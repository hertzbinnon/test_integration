...
do
{
wget -S -d --post-data "{\"cmd\":\"switch\",\"id\":0,\"stream_id\":\"0\",\"video_id\":\"0\",\"audio_id\":\"0\",\"effect\":\"fade\",\"duration\":1}" http://$2:8888/postserver  -O /dev/null
sleep $1
wget -S -d --post-data "{\"cmd\":\"switch\",\"id\":0,\"stream_id\":\"1\",\"video_id\":\"1\",\"audio_id\":\"1\",\"effect\":\"fade\",\"duration\":1}" http://$2:8888/postserver  -O /dev/null
