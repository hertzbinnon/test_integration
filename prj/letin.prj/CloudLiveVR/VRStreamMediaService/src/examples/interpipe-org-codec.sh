...
caps=video/x-raw,width=640,height=480,framerate=30/1 sync=false async=false
...
is-live=true allow-renegotiation=true ! videoconvert ! x264enc ! h264parse ! avdec_h264 ! videoconvert ! queue ! fpsdisplaysink async=false sync=false
