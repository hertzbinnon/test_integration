...
gstd-client pipeline_create pipe_1_src uridecodebin uri=udp://192.168.0.134:12346 name=source \
! "video/x-raw, framerate=30/1, width=720, height=576, format=Y444_10LE" ! queue ! interpipesink name=src_1 caps=video/x-raw,width=720,height=576,framerate=30/1 sync=false async=false \
...
gstd-client pipeline_create pipe_2_src uridecodebin uri=udp://192.168.0.134:12347 name=source \
! "video/x-raw, framerate=30/1, width=720, height=576, format=Y444_10LE" ! queue ! interpipesink name=src_2 caps=video/x-raw,width=720,height=576,framerate=30/1 sync=false async=false \
...
gstd-client pipeline_create pipe_3_src uridecodebin uri=udp://192.168.0.134:12348 name=source \
! "video/x-raw, framerate=30/1, width=720, height=576, format=Y444_10LE" ! queue ! interpipesink name=src_3 caps=video/x-raw,width=720,height=576,framerate=30/1 sync=false async=false \
