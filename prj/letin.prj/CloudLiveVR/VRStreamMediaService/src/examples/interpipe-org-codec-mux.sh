...
gstd-client pipeline_create pipe_11_src audiotestsrc wave=3 is-live=true ! queue ! audioconvert ! voaacenc ! aacparse ! queue ! interpipesink name=src_11 caps=audio/mpeg sync=false async=false
