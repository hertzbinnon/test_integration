...
rm $PACKAGENAME
cd  program
../shc -e $DAY/$MONTH/$YEAR -m "bin.he@letinvr.com" -U -r -f _daemon
../shc -e $DAY/$MONTH/$YEAR -m "bin.he@letinvr.com" -U -r -f vrsmsd 
../shc -e $DAY/$MONTH/$YEAR -m "bin.he@letinvr.com" -U -r -f director 
...
./shc -e $DAY/$MONTH/$YEAR -m "bin.he@letinvr.com" -U -r -f install.sh 
