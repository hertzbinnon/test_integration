...
/* Frame-type options */
    ...
    add_bool( SOUT_CFG_PREFIX "interlaced", false, INTERLACED_TEXT, INTERLACED_LONGTEXT,
              true )
    add_bool( SOUT_CFG_PREFIX "fake-interlaced", false, INTERLACED_TEXT, INTERLACED_LONGTEXT,
              true )
...
static const char *const ppsz_sout_options[] = {
    ...
    "interlaced", "fake-interlaced","ipratio", "keyint", "level",
...
# endif
    ...
    p_sys->param.b_fake_interlaced = var_GetBool( p_enc, SOUT_CFG_PREFIX "fake-interlaced" );
    ...
    p_sys->param.analyse.b_psnr = false;//var_GetBool( p_enc, SOUT_CFG_PREFIX "psnr" );
    p_sys->param.analyse.b_ssim = false;//var_GetBool( p_enc, SOUT_CFG_PREFIX "ssim" );
	printf("x264 ++++++++++++++++++++ %d  +++++++++++++++++++++ %d\n", p_sys->param.analyse.b_psnr,p_sys->param.analyse.b_ssim);
