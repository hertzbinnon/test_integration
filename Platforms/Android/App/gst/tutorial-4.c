...
static void *app_function (void *userdata) {
  ...
  //data->pipeline = gst_parse_launch("ahcsrc !  autovideoconvert ! videoscale ! "
  //             "video/x-raw,width=352,height=188 ! x264enc byte-stream=TRUE ! mp4mux ! filesink location=/storage/sdcard0/Movies/test.ts", &error);
