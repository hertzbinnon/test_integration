 ...
 * $Id: 67abfdf44f02ea21db86b1d0ae99f3849ef3488b $
 *
...
static void DoCreateES( demux_t *p_demux, ts_es_t *p_es, const ts_es_t *p_parent_es )
{
    ...
    for( ; p_es ; p_es = p_es->p_next )
    {
		...
		printf(" ------------------ Projection default = %d\n",p_es->fmt.video.projection_mode );
		p_es->fmt.video.projection_mode = PROJECTION_MODE_EQUIRECTANGULAR;
	    }
