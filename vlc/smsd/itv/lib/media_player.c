                     ...
                     void * p_userdata )
{
    ...
    if( newval.i_int == INPUT_EVENT_STATE )
    {
        ...
        switch ( var_GetInteger( p_input, "state" ) )
        {
            ...
            case ERROR_S_I:
                libvlc_state = libvlc_Error_I;
                event.type = libvlc_MediaPlayerEncounteredError_I;
                break;
            case ERROR_S_N:
                libvlc_state = libvlc_Error_N;
                event.type = libvlc_MediaPlayerEncounteredError_N;
                break;
            case ERROR_S_T:
                libvlc_state = libvlc_Error_T;
                event.type = libvlc_MediaPlayerEncounteredError_T;
                break;
...
libvlc_media_player_new( libvlc_instance_t *instance )
{
    ...
    register_event(mp, EncounteredError_I);
    register_event(mp, EncounteredError_N);
    register_event(mp, EncounteredError_T);
