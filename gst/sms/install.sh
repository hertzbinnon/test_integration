...
if [ ! -f \$1 ]; then 
	...
	#echo "python $1 "
	echo "su - smsd -c \". $INSTALL_PATH/bin/bash.sh && python3 $1 $INSTALL_PATH \$HTTP_PORT \$DEBUG > /dev/null 2>&1 &\""
...
cd ../setproctitle && python3 setup.py install
