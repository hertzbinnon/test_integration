...
gst-launch-1.0 videotestsrc is-live=true ! queue max-size-buffers=0 max-size-time=0 max-size-bytes=0 min-threshold-time=0  !  autovideoconvert ! x264enc byte-stream=TRUE bframes=3 key-int-max=25 ! queue ! mpegtsmux name=mux alignment=7  ! udpsink  host=192.168.0.166 port=12346  audiotestsrc is-live=true ! queue max-size-buffers=0 max-size-time=0 max-size-bytes=0 min-threshold-time=0 ! audioconvert ! audioresample ! avenc_aac ! queue   ! mux.   audiotestsrc is-live=true ! queue max-size-buffers=0 max-size-time=0 max-size-bytes=0 min-threshold-time=6000000000 ! audioconvert ! audioresample ! avenc_aac ! queue ! mpegtsmux name=mux1 alignment=7 ! udpsink  host=192.168.0.166 port=12347
